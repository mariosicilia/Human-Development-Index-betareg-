...
selezione_variabili$Gini.coefficient.2005.2013<-(selezione_variabili$Gini.coefficient.2005.2013/100) #per avere gini tra 0 e 1 poichè è espresso in percentuale nei dati di partenza
#descrittive Gini
...
# gini ora significativo accettando un livello di significatività pari a 10 %
